...
static void set_default_dma_ops(struct sde_hw_reg_dma *reg_dma)
{
	const static struct sde_hw_reg_dma_ops ops = {
		.check_support = default_check_support, .setup_payload = default_setup_payload,
		.kick_off = default_kick_off, .reset = default_reset, .alloc_reg_dma_buf = default_alloc_reg_dma_buf,
		.dealloc_reg_dma = default_dealloc_reg_dma, .reset_reg_dma_buf = default_buf_reset_reg_dma,
		.last_command = default_last_command, .last_command_sb = default_last_command_sb,
